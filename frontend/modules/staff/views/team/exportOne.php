    ...
    ?>
            ...
            <table>
                <tr>
                    ...
                    <td class="space" colspan="3">
                        <?= $member->user->lastNameUk ?> <?= $member->user->firstNameUk ?> <?= $member->user->middleNameUk ?>
                    </td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    ...
                    <td class="space">
                        <?= $member->user->lastNameEn ?> <?= $member->user->firstNameEn ?> <?= $member->user->middleNameEn ?>
                    </td>
                </tr>
            </table>

            <?php if ($member->user->info instanceof \common\models\User\InfoStudent): ?>
            <table>
                <tr>
                    <td width="110px">
                        Напрям навчання
            ...
            <table>
                <tr>
                    ...
                    <td class="space">
                        <?= $member->user->info->schoolAdmissionYear ?>
                    </td>
                    <td width="30px">
                        Курс
                    </td>
                    <td class="space">
                        <?= $member->user->info->course ?>
                    </td>
                    <td width="130px">
                        Студентський квиток
                    </td>
                    <td class="space">
                        <?= $member->user->info->document ?>
                    </td>
                </tr>
            </table>
            <?php endif; ?>
            ...
            <table>
                <tr>
                    ...
                    <td class="space">
                        <?= $member->user->info->phoneHome ?>
                    </td>
                    <td width="50px">
                        мобільний:
                    </td>
                    <td class="space">
                        <?= $member->user->info->phoneMobile ?>
                    </td>
                </tr>
            </table>
            <?php
