...
/* @var $email          string */
/* @var $error          string */
/* @var $confirmation   \common\models\User\EmailConfirmation */
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <?php $form = ActiveForm::begin([
                'options' => ['class' => 'auth-login form-horizontal col-lg-offset-1 col-lg-10'],
            ]) ?>
                <?php if (!empty($error)): ?>
                ...
                <div class="form-group">
                    ...
                    <a href="<?=Url::toRoute(['password-reset'])?>" rel="tooltip" title="<?=\yii::t('app', 'Forgot your password?')?>">
                        ?
                    </a>
                </div>
                <div class="form-group">
                    ...
                    <br />
                    <b><a href="<?=Url::toRoute(['signup'])?>"><?=\yii::t('app', 'Register now!')?></a></b>
                </div>
            <?php ActiveForm::end() ?>
        </div>
    </div>
